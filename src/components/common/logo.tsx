...
export function Logo(props: SVGProps<SVGSVGElement>) {
  ...
  const handleLogoHover = contextSafe((e: React.MouseEvent<HTMLDivElement>) => {
    const target = e.currentTarget;
    const wave = target.querySelector(".wave-path-group");
    const type = e.type;

    if (type === "mouseenter") {
      gsap.to(wave, { yPercent: 60, duration: 0.5, ease: "sine.out" });
      gsap.to(wave, {
        xPercent: -50,
        repeat: -1,
        duration: 3,
  ...
  return (
    ...
    >
      ...
      >
        <title id="logo-title">Fizzi</title>
